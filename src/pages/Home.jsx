        ...
        <section className=' pt-10 px-5'>
            <div className=' pl-5'>
                ...
                <p className=' text-justify text-md py-2 leading-8 text-gray-800 mx-auto dark:text-yellow-50 '>
                    I am a versatile professional with over 3+ years of experience in 
                    Programming and Data Science, adept at applying a diverse skill set across 
                    data-driven roles spanning backend, database management and frontend.
